...
export default function Products() {
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [products, categories, category, thaiOnly, artist, national, style, medium, collection, status, price, size, query, sort]);
  ...
  const filterLabel = cat ? (categories.find((item) => item.slug === cat)?.name ?? categoryFilter[cat]?.label ?? 'Search') : 'Search';
